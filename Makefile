...
PACKAGE_STRING = polarhrm 2013-06-16
PACKAGE_TARNAME = polarhrm
PACKAGE_URL = 
PACKAGE_VERSION = 2013-06-16
PATH_SEPARATOR = :
...
install-polarhrmdocDATA: $(polarhrmdoc_DATA)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(polarhrmdocdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(polarhrmdocdir)" || exit 1; \
	fi; \
	for p in $$list; do \
...
uninstall-polarhrmdocDATA:
	...
	dir='$(DESTDIR)$(polarhrmdocdir)'; $(am__uninstall_files_from_dir)
